...
Dynamically create Spring (proxy class) client from annotated interface. Very lightweight, only depends on (compile only) `spring-web`, compared to alternatives like [Feign](https://github.com/OpenFeign/feign).
