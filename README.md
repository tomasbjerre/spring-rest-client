...
Dynamically create Spring (proxy class) client from annotated interface. Very lightweight, only depends on `slf4j-api` and compiles against `spring-web`, compared to alternatives like [Feign](https://github.com/OpenFeign/feign).
